                          ...
                          <div>
                            <div className="row">
                              <div className="col-lg-7">
                                ...
                                <div className="line-dec"></div>
                                <p>
                                  Tale is the best SEO agency website template using Bootstrap v5.2.2 CSS for your
                                  company. It is a free download provided by TemplateMo. There are 3 HTML pages,{' '}
                                  <a href="index.html">Home</a>, <a href="about.html">About</a>, and{' '}
                                ...
                                <p>
                                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed doers eiusmod tempor
                                  incididunt ut labore et dolore dolor dolor sit amet, consectetur adipicing elit, sed
                                  doers eiusmod.
                                </p>
                              </div>
                              <div className="col-lg-5 align-self-center">
                          ...
                          <div>
                            <div className="row">
                              <div className="col-lg-7">
                                ...
                                <div className="line-dec"></div>
                                <p>
                                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed doers eiusmod kent tempor
